...
public class MyCamera2CaptureCallbackStatesTest extends TestCase {
  ...
  protected MyCamera2CaptureCallbackStatesTest(
  ...
  private static void setUpPreviewStateTest(TestSuite suite) {
    MyCamera2CaptureCallbackStatesTest previewStateTest =
        new MyCamera2CaptureCallbackStatesTest(
  ...
  private static void setUpWaitingFocusTests(TestSuite suite) {
    ...
    MyCamera2CaptureCallbackStatesTest nullStateTest =
        new MyCamera2CaptureCallbackStatesTest(
    ...
    for (Integer afState : actionableAfStates) {
      aeStatesConvergeMap.forEach(
          (aeState, shouldConverge) -> {
            MyCamera2CaptureCallbackStatesTest focusLockedTest =
                new MyCamera2CaptureCallbackStatesTest(
  ...
  private static void setUpWaitingPreCaptureStartTests(TestSuite suite) {
    ...
    cameraStateMap.forEach(
        (aeState, cameraState) -> {
          MyCamera2CaptureCallbackStatesTest testCase =
              new MyCamera2CaptureCallbackStatesTest(
  ...
  private static void setUpWaitingPreCaptureDoneTests(TestSuite suite) {
    ...
    for (Integer aeState : onConvergeStates) {
      MyCamera2CaptureCallbackStatesTest shouldConvergeTest =
          new MyCamera2CaptureCallbackStatesTest(
    ...
    MyCamera2CaptureCallbackStatesTest shouldNotConvergeTest =
        new MyCamera2CaptureCallbackStatesTest(
    ...
    MyCamera2CaptureCallbackStatesTest shouldConvergeWhenTimedOutTest =
        new MyCamera2CaptureCallbackStatesTest(
            "process_should_not_converge_when_ae_state_is_pre_capture",
            CameraState.STATE_WAITING_PRECAPTURE_DONE,
            null,
